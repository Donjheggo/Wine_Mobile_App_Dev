...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex flex-row h-12 lg:h-10 native:h-14 items-center text-base lg:text-sm native:text-lg native:leading-[1.4] justify-between rounded-2xl border border-input bg-background px-4 web:ring-offset-background text-muted-foreground web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2 [&>span]:line-clamp-1",
